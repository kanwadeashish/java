class Souei extends Tensura{
	...
	public Souei(String name,int id){
	...
	public Souei(String name,int id,long phoneNumber){
	...
	public Souei(String name,int id,long phoneNumber,double percentage){
	...
	public Souei(String name,int id,long phoneNumber,double percentage,float passRate){
	...
	public Souei(String name,int id,long phoneNumber,double percentage,float passRate,char rating){
	...
	public Souei(String name,int id,long phoneNumber,double percentage,float passRate,char rating,boolean isGraduate){
