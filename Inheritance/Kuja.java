class Kuja extends Luffy{
	...
	public Kuja(int id,String name){
	...
	public Kuja(int id,String name,long phoneNumber){
		
		super(1,"Luffy",123456789L);
	...
	public Kuja(int id,String name,long phoneNumber,double result){
		
		super(1,"Luffy",123456789L,99.99);
	...
	public Kuja(int id,String name,long phoneNumber,double result,float percentage){
		
		super(1,"Luffy",123456789L,99.99,98.98f);
	...
	public Kuja(int id,String name,long phoneNumber,double result,float percentage,char rating){
		
		super(1,"Luffy",123456789L,99.99,98.98f,'a');
	...
	public Kuja(int id,String name,long phoneNumber,double result,float percentage,char rating,boolean isPassed){
		
		super(1,"Luffy",123456789L,99.99,98.98f,'a',true);
