class Robin extends Zoro{
	...
	public Robin(int id,String name){
	...
	public Robin(int id,String name,long phoneNumber){
		
		super(1,"Zoro",123456789L);
	...
	public Robin(int id,String name,long phoneNumber,double result){
		
		super(1,"Zoro",123456789L,99.99);
	...
	public Robin(int id,String name,long phoneNumber,double result,float percentage){
		
		super(1,"Zoro",123456789L,99.99,98.98f);
	...
	public Robin(int id,String name,long phoneNumber,double result,float percentage,char rating){
		
		super(1,"Zoro",123456789L,99.99,98.98f,'a');
	...
	public Robin(int id,String name,long phoneNumber,double result,float percentage,char rating,boolean isPassed){
		
		super(1,"Zoro",123456789L,99.99,98.98f,'a',true);
