class Benimaru extends Tensura{
	...
	public Benimaru(String name,int id){
	...
	public Benimaru(String name,int id,long phoneNumber){
	...
	public Benimaru(String name,int id,long phoneNumber,double percentage){
	...
	public Benimaru(String name,int id,long phoneNumber,double percentage,float passRate){
	...
	public Benimaru(String name,int id,long phoneNumber,double percentage,float passRate,char rating){
	...
	public Benimaru(String name,int id,long phoneNumber,double percentage,float passRate,char rating,boolean isGraduate){
