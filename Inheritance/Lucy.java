class Lucy extends Edward{
	...
	public Lucy(int id,String name){
	...
	public Lucy(int id,String name,long phoneNumber){
		
		super(1,"Edward",123456789L);
	...
	public Lucy(int id,String name,long phoneNumber,double result){
		
		super(1,"Edward",123456789L,99.99);
	...
	public Lucy(int id,String name,long phoneNumber,double result,float percentage){
		
		super(1,"Edward",123456789L,99.99,98.98f);
	...
	public Lucy(int id,String name,long phoneNumber,double result,float percentage,char rating){
		
		super(1,"Edward",123456789L,99.99,98.98f,'a');
	...
	public Lucy(int id,String name,long phoneNumber,double result,float percentage,char rating,boolean isPassed){
		
		super(1,"Edward",123456789L,99.99,98.98f,'a',true);
