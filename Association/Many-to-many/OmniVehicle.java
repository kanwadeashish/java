class OmniVehicle{
	...
	public OmniVehicle(String vehicleBrand,int vehiclePrice,Tyre tyre,Seats seats,Engine engine){
	...
	public void displayOmniVehicleInfo(){
		
		System.out.println("This is OmniVehicle class.");
