class NanoVehicle{
	...
	public NanoVehicle(String vehicleBrand,int vehiclePrice,Tyre tyre,Seats seats,Engine engine){
	...
	public void displayNanoVehicleInfo(){
		
		System.out.println("This is NanoVehicle class.");
